...
const init = () => {
    ...
    const cards = document.querySelectorAll('.card') // для index tag hot и ответов
    const question_detail = document.querySelector('.question_detail') // для question_detail
